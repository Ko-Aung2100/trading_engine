...
def run_backtest(csv_path="data/spy_2000-2020.csv", time_range="1y"):
    """Runs a backtest and zooms the chart to a specific time duration."""
    ...
    # 4. SLICE DATA FOR CHARTING (Time-Based Zoom)
    if time_range != "all":
        end_date = df.index[-1] # The very last day in your CSV
        ...
        # Filter the dataframe to only show dates after our start_date
